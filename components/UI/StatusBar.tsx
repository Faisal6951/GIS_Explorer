...
import { formatCoord, zoomToScale, toDMS } from '@/lib/utils';
...
export default function StatusBar() {
  ...
  return (
    <div className="flex items-center justify-between px-2 sm:px-4 h-7 bg-surface-1 border-t border-border flex-shrink-0 text-[10px] font-mono overflow-x-auto">
      {/* Left */}
      <div className="flex items-center gap-2 sm:gap-4 text-gray-500 flex-shrink-0">
        ...
        {state.coordinates ? (
          ...
          <span className="text-gray-600 hidden sm:inline">Move cursor over map</span>
        )}
      </div>
      ...
      <div className="hidden md:flex items-center gap-4 text-gray-600">
        ...
        <span className="hidden lg:inline">WGS84 / EPSG:4326</span>
        <span className="hidden lg:inline">Tiles: OpenFreeMap</span>
      </div>
      ...
      <div className="flex items-center gap-2 sm:gap-3 text-gray-600 flex-shrink-0">
        ...
        <span className="text-gray-700 hidden sm:inline">© OSM</span>
      </div>
    </div>
  );
}
